...
[ -f "/usr/bin/logo-ls" ] && alias ls="logo-ls"
[ -f "/usr/bin/nvim" ] && alias vim="nvim"

if [ ! -d "$HOME/.fzf" ]
then
  git clone --depth 1 https://github.com/junegunn/fzf.git $HOME/.fzf
  $HOME/.fzf/install --no-key-bindings --no-completion --no-bash --no-update-rc
fi
...
alias ckc="kubectx"
alias ckn="kubens"
alias shh='ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null'
...
cat >~/.p10k.zsh <<\END
# Generated by Powerlevel10k configuration wizard on 2021-04-13 at 09:16 EEST.
